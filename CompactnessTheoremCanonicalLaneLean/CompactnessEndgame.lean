import compactnessTheoremCanonicalLaneLean.UltrafilterLemma
...
theorem constrained_compactness_endgame (A : AdmissibleClass) : ConstrainedCompactnessClosure A := by
